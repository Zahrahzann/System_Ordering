...
<body id="page-top">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-section">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" id="status" name="status" required>
                                                    <option value="Ordered" <?= ($old['status'] ?? $item['status'] ?? '') == 'Ordered' ? 'selected' : '' ?>>Ordered</option>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="material_id">Material <span class="required">*</span></label>
                                                <select class="form-control" id="material_id" name="material_id" required>
                                                    <option value="">-- Pilih Material --</option>
                                                    <?php foreach ($materials as $m): ?>
                                                        <option value="<?= $m['id'] ?>"
                                                            <?= ($old['material_id'] ?? $item['material_id'] ?? '') == $m['id'] ? 'selected' : '' ?>>
                                                            <?= $m['name'] ?> - <?= $m['dimension'] ?>
                                                        </option>
                                                    <?php endforeach; ?>
                                                </select>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="stock" name="stock"
                                                    value="<?= htmlspecialchars($item['stock'] ?? '') ?>" readonly>
                                            </div>
                                        </div>
    ...
    <script>
        ...
        // AJAX untuk material stock
        $('#material_id').on('change', function() {
            const id = $(this).val();
            if (!id) return;
            $.getJSON('<?= $basePath ?>/api/material/' + id, function(data) {
                $('#stock').val(data.stock + ' Unit');
            });
        });
        ...
        // set kondisi awal sesuai checkbox
